...
$(document).ready(function () {
    ...
    $('#imgur_select').html(
        ...
        '<img src="https://media.giphy.com/media/sYj2vTqDbMli/giphy.gif" id="image_preview" class="thumbnail col-sm-4" width="100%"/>'
    );
//on cache la preview de l'image dans un premier temps
    $("#image_preview").hide();
